...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "introSubhead",
      type: "string",
      required: false,
      label: "Workspace Subhead",
      maxLength: 320,
    },
    {
    ...
    // ── Core engine config ─────────────────────────────────────────────────
    {
      fieldName: "playsToGenerate",
      type: "number",
      required: false,
      label: "Strategies Per Run",
      min: 3,
      max: 8,
    },
    {
    ...
    },
    {
      ...
      item: {
        type: "object",
        fields: [
          { fieldName: "id", type: "string", required: true, label: "Stage ID" },
          { fieldName: "label", type: "string", required: true, label: "Stage Label" },
          { fieldName: "hint", type: "string", required: false, label: "Stage Hint" },
        ],
      },
    },
  ],
